...
import com.susion.lifeclean.mvp.GitRepoMvpPage
import com.susion.lifeclean.mvvm.GitRepoMvvmPage
import com.susion.lifeclean.page.GitHubLifePage
...
class SimplePageContainerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val contentView = when (page) {
            MVP -> GitRepoMvpPage(this)
            MVVM -> GitRepoMvvmPage(this)
            LIFE -> LifeClean.createPage<GitHubLifePage>(this)
            else -> View(this)
        }
