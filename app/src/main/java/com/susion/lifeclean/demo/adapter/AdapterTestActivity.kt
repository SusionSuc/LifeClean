package com.susion.lifeclean.demo.adapter
...
import com.susion.lifeclean.demo.adapter.view.SimpleInfo
import com.susion.lifeclean.demo.adapter.view.SimpleInfoView
...
//        adapterForDiffAdapter()
    ...
    private fun adapterForCommon() {
        adapter.data.addAll(listOf("aaaa", "bbbb", "cccc", "dddd",
            SimpleInfo("xxxx")
        ))
